...
<?php _e( 'Skip to content', 'news-host' ); ?></a>
    <div class="wrapper" id="custom-background-css">
        <header class="mg-headwidget">
            <!--==================== TOP BAR ====================-->
            <?php do_action('news_host_action_header_section');  ?>
            ...
            $newsup_header_overlay_color = get_theme_mod('newsup_header_overlay_color', 'rgba(10, 0, 0, 0.25)');?> style="background-color:<?php echo esc_attr($newsup_header_overlay_color);?>;" <?php } ?>> 
        ...
        <div class="container-fluid flex-row">
          <!-- Right nav -->
              <div class="m-header pl-3 ml-auto my-2 my-lg-0 position-relative align-items-center">
                  ...
                  <button class="navbar-toggler mx-auto" type="button" data-toggle="collapse" data-target="#navbar-wp" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','news-host'); ?>">
                <span class="burger">
...
<?php $show_popular_tags_title = newsup_get_option('show_popular_tags_title');
 ...
 do_action('news_host_action_front_page_main_section_1'); ?>