				...
				<div class="trn-form-group">
					...
					<div class="trn-col-sm-4">
						<p class="trn-form-control-static">
							...
							<?php printf( esc_html__( '%d Tokens', 'tournamatch' ), intval( $tournament->mycred_entry_fee ) ); ?>
						</p>
					</div>
				</div>
			<?php endif; ?>
...
$options = array(
	...
	'redirect_link' => trn_route( 'tournaments.single.registered', array( 'id' => $tournament_id ) ),
	'language'      => array(
