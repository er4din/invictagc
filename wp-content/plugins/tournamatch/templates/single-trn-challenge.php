...
<dl>
	...
	<?php if ( trn_is_plugin_active( 'trn-mycred' ) ) : ?>
		...
		<dd><?php printf( esc_html__( '%d Tokens', 'tournamatch' ), intval( $challenge->mycred_wager_amount ) ); ?></dd>
	<?php endif; ?>
	<dt><?php esc_html_e( 'Status', 'tournamatch' ); ?>:</dt>
	<dd id="trn-challenge-status"><?php echo esc_html( trn_get_localized_challenge_state( $challenge->accepted_state ) ); ?></dd>
</dl>
