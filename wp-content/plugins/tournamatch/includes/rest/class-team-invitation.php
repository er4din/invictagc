...
class Team_Invitation extends Controller {
	...
	public function create( \WP_REST_Request $request ) {
		...
		$data      = array(
			'team_link'   => trn_route( 'teams.single', array( 'id' => $team_id ) ),
			'team_name'   => $team_name,
			'accept_link' => trn_route( 'magic.accept-team-invitation', array( 'join_code' => $accept_hash ) ),
		);
	...
	public function accept( \WP_REST_Request $request ) {
		...
		$data = array(
			'team_link' => trn_route( 'teams.single', array( 'id' => $team_id ) ),
			'team_name' => $team_name,
			'user_link' => trn_route( 'players.single', array( 'id' => $user_id ) ),
			'user_name' => $user_name,
		);
	...
	public function decline( \WP_REST_Request $request ) {
		...
		$data = array(
			'team_link' => trn_route( 'teams.single', array( 'id' => $invitation->team_id ) ),
			'team_name' => $team_name,
			'user_link' => trn_route( 'players.single', array( 'id' => $invitation->user_id ) ),
			'user_name' => $user_name,
		);
